        ...
        {step === 'mapping' && (
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
            ...
            <p className="text-slate-600 mb-6">
              Hemos analizado tu archivo y emparejado los títulos dinámicamente. Verifica que las columnas sean correctas.
            </p>
        ...
        {step === 'dashboard' && processedData && (
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="flex-1 bg-white rounded-2xl shadow-sm border border-slate-200 p-6 overflow-x-auto">
              ...
              {activeTab === 'mod1' && (
                <div>
                  <h2 className="text-2xl font-bold mb-6 text-slate-800 border-b pb-4">Módulo 1: Epidemiología Laboral</h2>
              ...
              {activeTab === 'mod4' && (
                <div className="max-w-4xl">
                  <h2 className="text-2xl font-bold mb-6 text-slate-800 border-b pb-4">Módulo 4: Conclusiones y Recomendaciones</h2>
